...
class UserCreate(UserBase):
    ...
    permessi: Optional[Dict[str, Any]] = None
...
class ImpostazioniAziendaBase(BaseModel):
    ...
    backup_nas_path: Optional[str] = None
    backup_nas_enabled: Optional[bool] = False
    backup_cloud_provider: Optional[str] = None
    backup_cloud_enabled: Optional[bool] = False
    backup_local_path: Optional[str] = None
    backup_keep_count: Optional[int] = 10
    # Scheduler e Retention Backup
    backup_local_keep_count: Optional[int] = 10
    backup_local_schedule_enabled: Optional[bool] = False
    backup_local_schedule_time: Optional[str] = "02:00"
    backup_nas_keep_count: Optional[int] = 10
    backup_nas_schedule_enabled: Optional[bool] = False
    backup_nas_schedule_time: Optional[str] = "02:00"
...
class BackupRestoreRequest(BaseModel):
    restore_type: str = "full"  # full, database, volumes, config

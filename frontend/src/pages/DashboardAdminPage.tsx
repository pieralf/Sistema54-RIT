...
import { PlusCircle, Users, Package, Archive, Settings, User, Activity, LogOut, Shield, FileText, HardDrive } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            {/* Mostra link impostazioni solo se SuperAdmin o ha permesso can_view_settings */}
            {(user?.ruolo === 'superadmin' || user?.permessi?.can_view_settings === true) && (
              <Link
                to="/settings"
      ...
      <main className="max-w-6xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          ...
          {/* Card Backup - solo per superadmin */}
          {user?.ruolo === 'superadmin' && (
            ...
            >
              <div className="relative z-10">
                ...
                <h3 className="text-lg font-bold text-slate-800">Backup</h3>
                <p className="mt-1 text-sm text-slate-500">Gestisci backup e ripristini</p>
              </div>
            </Link>
          )}
        </div>
